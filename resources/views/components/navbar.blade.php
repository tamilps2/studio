<nav class="navbar d-flex flex-row justify-content-around shadow-sm py-3">
    <div class="btn-group pl-0 col-3 d-flex justify-content-lg-center justify-content-start align-items-center">
    ...
    @auth()
        <div class="btn-group pr-0 col-3 d-flex justify-content-lg-center justify-content-end align-items-center">
            @yield('actions')
    ...
    @guest()
        <div class="col-3 pr-0 d-flex justify-content-lg-center justify-content-end align-items-center">

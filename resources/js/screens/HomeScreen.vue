<template>
    <div>
        ...
        <div v-if="!hasErrors" class="col-xl-10 offset-xl-1 col-md-12">
            <router-link v-if="featuredPost" :to="{ name: 'post', params: { identifier: postPublicIdentifier(featuredPost), slug: featuredPost.slug } }" class="text-decoration-none">
            ...
            <main role="main" class="row justify-content-between">
                ...
                <div v-if="isReady && posts.length < 1 && !featuredPost" class="col-12">
